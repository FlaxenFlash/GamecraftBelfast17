...
namespace BitStrap
{
    public class BehaviourButtonsHelper
    {
        ...
        public void Init( Object[] targetObjects )
        {
            this.targetObjects = targetObjects;
            methods = targetObjects.First().GetType().GetMethods( BindingFlags.Public | BindingFlags.NonPublic | BindingFlags.Instance ).Where( m =>
